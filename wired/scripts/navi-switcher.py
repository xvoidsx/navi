...
def show(outdir):
    ...
    css.load_from_data(b"""
        ...
        #navi-switcher .tile-title { color: #f2ecf5; font: 12px "Noto Sans"; }
        #navi-switcher .tile-ws { color: #8a8a96; font: 10px "Noto Sans"; }
        #navi-switcher .tile-app { color: #39ff14; font: 10px "Noto Sans"; }
    """)
