...
var knownHarnesses = []struct{ bin, hint string }{
	...
	{"aider", "naviApps → Agents shelf"},
	{"kilo", "naviApps → Agents shelf"},
	{"copilot", "naviApps → Agents shelf"},
	{"kimi", "naviApps → Agents shelf"},
	{"claude", "naviApps → Agents shelf"},
	{"gemini", "naviApps → Agents shelf"},
	{"codex", "navi-extras"},
	{"agy", "navi-extras"},
}
